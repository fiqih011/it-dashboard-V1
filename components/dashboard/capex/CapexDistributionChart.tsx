...
export default function CapexDistributionChart({
  data,
  noCapex,
  loading = false,
  error = null,
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-base font-semibold text-gray-900">
            Distribusi Pemakaian Budget — No CAPEX {noCapex}
          </h3>
        </div>
        <div className="p-6">
          <LoadingState />
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
        ...
        <div className="p-6">
          <EmptyState
            ...
            description="Tidak ada distribusi budget untuk No CAPEX ini"
          />
        </div>
      </div>
    );
  ...
  const getBarColor = (percentage: number): string => {
    if (percentage > 100) return "#EF4444";  // Red - Over 100%
    if (percentage >= 80) return "#F59E0B";  // Amber - 80-100%
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
          <div className="flex items-start gap-2">
            ...
            <div className="text-xs text-blue-800">
              <strong>Catatan:</strong> Chart menampilkan semua komponen dalam No CAPEX ini, diurutkan dari realisasi terkecil
