...
// ── Types ──────────────────────────────────────────────
export type OpexGroupedBarItem = {
  code: string;
  name: string;
  totalBudget: number;
  used: number;
...
type ProcessedItem = OpexGroupedBarItem & {
  remaining: number;
  pct: number;
  status: Status;
};
...
// ── Main Component ─────────────────────────────────────
export default function OpexGroupedBarChart({ data, loading = false, error = null }: Props) {
